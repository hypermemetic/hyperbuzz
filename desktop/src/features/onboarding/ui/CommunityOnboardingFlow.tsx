...
const STARTER_PERSONA_ANIMATIONS: Record<string, string> = {
  Vertex: "/onboarding/starter-team/fizz.png",
  Echo: "/onboarding/starter-team/honey.png",
  Scout: "/onboarding/starter-team/bumble.png",
};
...
export function CommunityOnboardingFlow({
  ...
  React.useEffect(() => {
    ...
    void listPersonas()
      .then((personas) =>
        setStarterPersonas(
          ["Vertex", "Echo", "Scout"].flatMap((name) => {
          ...
          transaction.stage === "connecting" ? (
            ...
            <>
              ...
              <p className="mx-auto mt-3 max-w-[400px] text-sm leading-6 text-foreground/80">
                Hyperbuzz lets you bring multiple agents into the same
                workspace. Your team will help you get started using Hyperbuzz.
              </p>
