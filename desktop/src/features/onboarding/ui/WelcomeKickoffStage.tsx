...
const STAGE_CHARACTERS: readonly StageCharacter[] = [
  { name: "Vertex", animationUrl: "/onboarding/starter-team/fizz.png" },
  { name: "Echo", animationUrl: "/onboarding/starter-team/honey.png" },
  { name: "Scout", animationUrl: "/onboarding/starter-team/bumble.png" },
];
