...
export const WELCOME_CANVAS_CONTENT = `# Welcome to Hyperbuzz

This private channel is your home base for getting oriented. Vertex, Echo, and Scout can help you learn the app, troubleshoot setup, and work through something you are building.
...
Ask the team a question here, or read the [Hyperbuzz user guide](https://github.com/block/buzz#readme).
`;
