...
const COPY_SUCCESS_MESSAGE =
  "Signed response copied. Paste it into the Hyperbuzz admin console.";
const PREVIEW_COPY_SUCCESS_MESSAGE = "Preview response copied.";
const COPY_FAILURE_MESSAGE =
  "Hyperbuzz couldn't access the clipboard. Try again.";
    ...
    const unlistenPromise = listenForNostrBindDeepLinks((nextPayload) => {
      ...
      getIdentity()
        ...
        .catch((error) => {
          ...
          setIdentity(null);
          setError("Could not load the current Hyperbuzz identity.");
        });
    });
                ...
                >
                  <DialogPrimitive.Title className="mt-6 text-3xl font-semibold tracking-tight">
                    {payload.returnMode === "browser_fragment_v1"
                      ...
                      : "Finish on the Hyperbuzz website"}
                  ...
                  >
                    {payload.returnMode === "browser_fragment_v1"
                      ? "Hyperbuzz opened your browser to finish verification."
                      : "Copy the response below, then paste it into the Hyperbuzz website to finish verification."}
                  </DialogPrimitive.Description>
