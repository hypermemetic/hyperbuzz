            ...
            <DialogDescription>
              {step === "sas"
                ...
                : step === "done"
                  ...
                  : "Scan this QR code with the Hyperbuzz mobile app to securely pair."}
            </DialogDescription>
          </DialogHeader>
            ...
            {step === "error" && error ? (
              ...
              <div className="space-y-4">
                <div className="flex flex-col items-center gap-3 py-4">
                  ...
                  <p className="text-center text-xs text-muted-foreground">
                    You are about to transfer your Hyperbuzz identity to another
  ...
  return (
    <section className="min-w-0" data-testid="settings-mobile">
      <SettingsSectionHeader
        ...
        description={
          <>
            Connect the Hyperbuzz mobile app to this relay by scanning a QR
