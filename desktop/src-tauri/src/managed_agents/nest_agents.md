...
Your persistent workspace. Created once by the Hyperbuzz desktop app. The static content above the managed-section markers is regenerated on upgrades — add custom notes below the markers or in separate files.
...
*(No agents deployed yet. Add agents in the Hyperbuzz desktop app.)*
