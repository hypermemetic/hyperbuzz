...
//! Hyperbuzz instance administration CLI.
//!
...
#[derive(Parser)]
#[command(name = "buzz-admin", about = "Hyperbuzz instance administration")]
struct Cli {
    #[command(subcommand)]
    command: Command,
}
...
enum Command {
    ...
    Migrate,
    /// Inspect deployment-wide Hyperbuzz product feedback.
    ProductFeedback {
        #[command(subcommand)]
